...
if __name__ == '__main__':
    ...
    # print(dataset_train.size / 785)  # 10000 element with label TRAIN
    # print(dataset_eval.size / 785) #2000 element with label VALIDATION
    # print(test_data.size / 784) #50000 element with label TEST
    #
    # print(dataset_train)
    # print(dataset_eval)
    # print(test_data)
    ...
    np.save('20186029_network_3.npy', result)
